...
export const mealParserPrompt = [
  ...
  "10. Rispetta i nomi composti degli alimenti italiani: non spezzare parole o espressioni che insieme indicano un alimento diverso.",
  "Esempi importanti: 'pesca noce', 'pesche noci' e 'nettarina' indicano il frutto simile alla pesca, non le noci/frutta secca; 'pane integrale' e' pane, non pane + integratore; 'latte di mandorla' e' una bevanda, non latte vaccino + mandorle separate.",
  "Se l'utente scrive 'ho mangiato pesche noci', crea un item chiamato 'pesche noci' o 'nettarine' con valori da frutto fresco, senza aggiungere noci.",
